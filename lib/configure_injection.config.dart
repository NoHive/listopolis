...
import 'features/listopolis/application/online_lists/onlinelists_bloc.dart'
    as _i13;
import 'features/listopolis/application/templates/template_bloc.dart' as _i18;
import 'features/listopolis/data/core/injectable_modules.dart' as _i21;
import 'features/listopolis/data/datasources/data_source.dart' as _i11;
import 'features/listopolis/data/datasources/local_storage.dart' as _i12;
...
Future<_i1.GetIt> $initGetIt(
  ...
  gh.factory<_i15.AuthenticationBloc>(
      () => _i15.AuthenticationBloc(get<_i7.IAuthRepository>()));
  gh.factory<_i16.ConnectivityBloc>(
      () => _i16.ConnectivityBloc(get<_i7.IConnectivityChecker>()));
  gh.lazySingleton<_i11.IUserDataSource>(
  ...
  gh.lazySingleton<_i7.IRepository>(() => _i17.RepositoryImpl(
        dataSource: get<_i11.IUserDataSource>(instanceName: 'UserData'),
        backupDataSource: get<_i11.IUserDataSource>(instanceName: 'BackupData'),
      ));
  gh.factory<_i18.TemplateBloc>(
      () => _i18.TemplateBloc(repository: get<_i7.IRepository>()));
  gh.factory<_i19.ActivelistBloc>(
      () => _i19.ActivelistBloc(repository: get<_i7.IRepository>()));
  gh.factory<_i20.CreatelistBloc>(
      () => _i20.CreatelistBloc(repository: get<_i7.IRepository>()));
  return get;
}
